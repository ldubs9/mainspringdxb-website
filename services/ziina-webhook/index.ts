// Standalone Ziina Webhook service for Coolify (Deno)
// Expects env: MAINSPRING_ZIINA_API_KEY, SUPABASE_URL, SUPABASE_SERVICE_ROLE_KEY
...
Deno.serve(async (req: Request) => {
  ...
  try {
    ...
    if (!paymentIntentId) return new Response("Missing payment_intent_id", { status: 400 });
